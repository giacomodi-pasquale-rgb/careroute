...
- **99 decision-ready locations:** records that passed CareRoute's release-blocking checks and may appear in patient results, including urgent-care coverage across every Northeast pilot state
