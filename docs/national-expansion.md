...
1. **National identity seed:** CMS Hospital General Information supplies hospital identity, address, phone, hospital characteristics, and whether emergency services are reported.
2. **Service evidence review:** a provider, state, or other authoritative source must establish hours, patient population (adult, pediatric, or both), location-level emergency or urgent-care capability, and coordinates. CMS emergency status alone is insufficient for patient routing.
